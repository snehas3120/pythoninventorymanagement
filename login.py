...
class Login:
    ...
    def __init__(self):
        self.loginw=Tk()
        self.loginw.title("Aanojs Saloon")
        width = 500
        height = 600
    ...
    def obj(self):
        ...
        self.register = Button(self.loginframe,width=20, text = " Register ",bg="white",fg="blue",command = self.reguser,font="Roboto 14")
        self.register.place(x=35,y=330)
